...
void changer_etat_aspiro(){digitalWrite(13, !digitalRead(13));
                            if (digitalRead(13)){ servo(F("Servo_baie_arriere_droite"), 150);servo(F("Servo_baie_droite_gauche"), 20);}
                            else {servo(F("Servo_baie_arriere_droite"), 110);servo(F("Servo_baie_droite_gauche"), 65);}}

// pour les changements de zone sans passe d'un bras à l'autre

void bras1_haut(){servo(F("Servo_levage1"),93);}
